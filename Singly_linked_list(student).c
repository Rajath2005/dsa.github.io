...
struct stud
{
    long long int ph;
    int sem;
    char name[20],usn[15],brnch[10];
    struct stud *next;
}*head=NULL,*tail=NULL,*temp=NULL,*temp1;

void create(long long int n, int s, char na[20],char u[15],char b[10])
{
    if(head==NULL)
    {
...
void insert_head(long long int n, int s, char na[20],char u[15],char b[10])
{
    temp=(struct stud*)malloc(1*sizeof(struct stud));
    temp->ph=n;
    temp->sem=s;
...
void insert_tail(long long int n,int s,char na[20],char u[15],char b[10])
{
    temp=(struct stud*)malloc(1*sizeof(struct stud));
    temp->ph=n;
    temp->sem=s;
